...
This document will show you how to interact with your contract deployed to [insert-chain] using React
...
### Initialize SDK On [insert-chain]

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to your desired EVM chain
...
Full reference: [https://portal.thirdweb.com/react/connecting-wallets](https://portal.thirdweb.com/react/connecting-wallets)
